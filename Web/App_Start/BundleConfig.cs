    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle("~/Content/css/jquery-ui/bundle")
                   .Include("~/Content/hht/css/style.css",
            ...
            bundles.Add(new StyleBundle("~/bundles/css")
                .Include("~/Content/hht/css/style.css", new CssRewriteUrlTransform())
                .Include("~/Content/hht/css/slider.css", new CssRewriteUrlTransform())
                .Include("~/Content/hht/css/slider_flexisel.css", new CssRewriteUrlTransform())
                 .Include("~/Content/hht/css/tinyscrollbar.css", new CssRewriteUrlTransform())
                  .Include("~/Content/hht/css/neo.css", new CssRewriteUrlTransform())
                   .Include("~/Content/css/animate.css", new CssRewriteUrlTransform())
                    .Include("~/Content/hht/css/hht-v.css", new CssRewriteUrlTransform())
                      .Include("~/Content/css/summernote/dist/summernote.css", new CssRewriteUrlTransform())
            ...
            bundles.Add(new ScriptBundle("~/bundles/app-js").Include(
                ...
                "~/Scripts/MyScripts/ajaxHelpers.js",
                 "~/Content/hht/js/App-Auth.js",
                "~/Content/hht/js/bootstrap.min.js",
                "~/Content/hht/js/jquery.tinyscrollbar.js",
                "~/Content/hht/js/jquery.flexisel.js",
                "~/Content/Plugin/toastr/toastr.min.js",
                "~/Content/hht/js/sample.js"
                ));
