...
<script runat="server">
	...
	public override void SetConfig()
	{
        ...
        BaseUrl = myUrl.BaseUrl()+"uploads/";

		// The phisical directory in the server where the file will end up. If
		// blank, CKFinder attempts to resolve BaseUrl.
        BaseDir = Request.PhysicalApplicationPath+"uploads\\"; 
       ...
       // VD.Data.Temp.loginVM tai_khoan = myUser.SSgetUserLoged();
		...
		type.Url = BaseUrl + "media/files/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "media/files/";
		type.MaxSize = 0;
		type.AllowedExtensions = new string[] { "exe","7z", "aiff", "asf", "avi", "bmp", "csv", "doc", "docx", "fla", "flv", "gif", "gz", "gzip", "jpeg", "jpg", "mid", "mov", "mp3", "mp4", "mpc", "mpeg", "mpg", "ods", "odt", "pdf", "png", "ppt", "pptx", "pxd", "qt", "ram", "rar", "rm", "rmi", "rmvb", "rtf", "sdc", "sitd", "swf", "sxc", "sxw", "tar", "tgz", "tif", "tiff", "txt", "vsd", "wav", "wma", "wmv", "xls", "xlsx", "zip" };
		type.DeniedExtensions = new string[] { };

		type = ResourceType.Add( "Images" );
        type.Url = BaseUrl + "media/images";
        type.Dir = BaseDir == "" ? "" : BaseDir + "media/images/";
		type.MaxSize = 0;
		type.AllowedExtensions = new string[] { "bmp", "gif", "jpeg", "jpg", "png","JPG","BMP","JPEG","PNG","GIF" };
		type.DeniedExtensions = new string[] { };

		type = ResourceType.Add( "Flash" );
		type.Url = BaseUrl + "media/flash/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "media/flash/";
		type.MaxSize = 0;
		type.AllowedExtensions = new string[] { "swf", "flv" };
		type.DeniedExtensions = new string[] { };

        type = ResourceType.Add("Videos");
        type.Url = BaseUrl + "media/videos";
        type.Dir = BaseDir == "" ? "" : BaseDir + "media/videos/";
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] {  "mp4", "flv"};
        type.DeniedExtensions = new string[] { };

        type = ResourceType.Add("Musics");
        type.Url = BaseUrl + "media/musics";
        type.Dir = BaseDir == "" ? "" : BaseDir + "media/musics/";
        type.MaxSize = 0;
