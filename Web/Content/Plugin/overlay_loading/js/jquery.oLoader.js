...
(function($) {
    ...
    $.ownage.Loader = function(el, params, selector, number) {
        ...
        base.preloadImages = function() {
            var images = [
                '/Content/Plugin/overlay_loading/images/ownageLoader/loader1.gif',
                '/Content/Plugin/overlay_loading/images/ownageLoader/loader2.gif',
                '/Content/Plugin/overlay_loading/images/ownageLoader/loader3.gif',
                '/Content/Plugin/overlay_loading/images/ownageLoader/loader4.gif',
                '/Content/Plugin/overlay_loading/images/ownageLoader/loader5.gif',
                '/Content/Plugin/overlay_loading/images/ownageLoader/loader6.gif',
                '/Content/Plugin/overlay_loading/images/ownageLoader/loader7.gif'
            ];
    ...
    $.ownage.Loader.defaultOptions = {
        image: '/Content/Plugin/overlay_loading/images/ownageLoader/loader1.gif',
        style: 1,
        context: 'body',
        modal: true,
        fadeInTime: 300,
